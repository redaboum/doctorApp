...
back-start:
	 sudo docker run -itd -name reda/django -p 3000:3000 -v ~/Desktop/doctorApp/:/home django bash -c "cd home && cd back && python manage.py runserver 0.0.0.0:3000"
...
back-restart-daemon:
	 sudo docker r -itd -p 3000:3000 -v /home/ubuntu/doctorApp:/home django bash -c "cd home && cd back && python manage.py runserver 0.0.0.0:3000"
